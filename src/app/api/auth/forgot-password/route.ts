...
export async function POST(req: Request) {
  try {
    ...
    await transporter.sendMail({
      from: `"TalentTie" <${process.env.SMTP_FROM}>`,
      to: email,
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;padding:32px;background:#f9fafb;border-radius:12px;">
          <img src="https://talenttie.com/logo-symbol.png" alt="TalentTie" style="height:48px;margin-bottom:24px;" />
          ...
          <p style="color:#9ca3af;margin-top:24px;font-size:13px;">This link expires in <strong>1 hour</strong>. If you did not request a password reset, ignore this email.</p>
          <hr style="border:none;border-top:1px solid #e5e7eb;margin:24px 0;" />
          <p style="color:#9ca3af;font-size:12px;">TalentTie Services | recruitment@talenttie.com | +91 9913677622</p>
        </div>
      `,
    })
